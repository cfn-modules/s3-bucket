...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>Private</td>
      <td>no</td>
      <td>[Private, PublicRead, CloudFrontRead, CloudFrontAccessLogWrite, ElbAccessLogWrite, ElbAccessLogCrossAccountWrite, ConfigWrite, ConfigCrossAccountWrite, CloudTrailWrite, CloudTrailCrossAccountWrite, FlowLogWrite, FlowLogCrossAccountWrite]</td>
    </tr>
    <tr>
      <td>Cors</td>
